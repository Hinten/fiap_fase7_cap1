...
from generator.criar_dados_leitura import criar_dados_leitura
from generator.criar_sensores import criar_sensores_padrao
from models.sensor import LeituraSensor, TipoSensorEnum, Sensor, TipoSensor
