...
| SNS_TOPIC_ARN      | ARN do tópico SNS da AWS para notificações por e-mail (opcional)                                    | `arn:aws:sns:us-east-1:123456789012:topic` |
| SNS_REGION      | Região da AWS onde o tópico SNS está configurado (opcional)                                              | `us-east-1`                       |
...
ENABLE_API=true
SNS_TOPIC_ARN=arn:aws:sns:us-east-1:123456789012:IrrigacaoNotificacoes
